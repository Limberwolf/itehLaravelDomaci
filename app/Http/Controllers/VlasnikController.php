...
use App\Http\Resources\VlasnikResource;
...
class VlasnikController extends Controller
{
    ...
    {
        $sviVlasnici = Vlasnik::all();
        return VlasnikResource::collection($sviVlasnici);
    }
    ...
    {
        $vlasnik->delete();
        return response()->json('Obrisan je željeni vlasnik!');
    }
}
